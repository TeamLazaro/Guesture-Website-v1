...
<div class="js_section_what_is_included">
	<div class="container">
		...
		<div class="row loading" style="position: fixed; z-index: 1; top: 0; left: 0; right: 0; bottom: 0; width: 100%; /*background-color: rgba(0,0,255,0.3);*/">
		...
		<div class="row what-is-included space-50-top space-100-bottom" style="position: relative; z-index: 2;">
		...
		<div class="row invalid-data space-50-top space-100-bottom" style="position: relative; z-index: 2;">
			<div class="columns small-12 fill-light" style="border-radius: 10px; overflow: hidden; box-shadow: 0px 0px 3px rgba(0,0,0,0.15), 0px 3px 8px rgba(0,0,0,0.15)">
