	...
	<div class="container">
		<div class="intro row space-50-bottom">
			<div class="columns small-10 small-offset-1">
				...
				<div class="h2 scroll-reveal" style="--td: 0.25s;">Just bring your bag.</div>
				<div class="h3 scroll-reveal" style="--td: 0.5s;">Say no to landlords, brokers and rent.</div>
				<div class="h3 strong scroll-reveal" style="--td: 0.75s;">Try Coliving instead.</div>
			</div>
		</div>
		<div class="points row">
			...
			<div class="columns small-10 small-offset-1 large-3 xlarge-offset-0">
				<div class="point scroll-reveal" style="--td: 1.25s;">
	...
	<div class="container">
		...
		<div class="trap row space-150-top-bottom">
			<div class="columns small-10 small-offset-1 medium-6 large-10">
				...
				<div class="points">
					<div class="point label inline text-uppercase space-min-bottom scroll-reveal pop" style="--td: 1.25s;">3 days and 2 nights</div><br>
...
<section class="live-section space-150-top-bottom">
	<div class="container">
		<div class="intro row">
			<div class="columns small-10 small-offset-1 large-6">
				...
				<div class="h3 text-neutral-5 space-min-bottom scroll-reveal" style="--td: .25s;">we built cultural spaces into your environment.</div>
			</div>
			<div class="description columns small-10 small-offset-1 medium-8 large-7 xlarge-6 space-50-bottom scroll-reveal" style="--td: .5s;">
		...
		<div class="amenities points row space-50-bottom">
			<div class="columns small-10 small-offset-1 medium-5 large-3">
				<div class="point scroll-reveal" style="--td: .75s;">
	...
	<div class="container">
		<div class="amenities points row space-50-top">
			<div class="columns small-10 small-offset-1 medium-5 large-3">
				<div class="point scroll-reveal" style="--td: .25s;">
	...
	<div class="container">
		...
		<div class="trap row space-150-top-bottom">
			<div class="columns small-10 small-offset-1 xlarge-9 space-50-top-bottom">
				<div class="h3 strong"><span class="opacity-50 scroll-reveal" style="--td: .5s;">Peace of mind for you and </span><span class="sparkle title-2-left title-2-right scroll-reveal pop" style="--td: 0.75s;">your parents</span></div>
				<div class="h0 text-red space-25-bottom scroll-reveal" style="--td: 1s;">womens only block</div>
				<div class="action row scroll-reveal" style="--td: 1.25s;">
					<!-- Phone Trap Trigger -->
					<label class="phone-trap-trigger form-row columns small-12 medium-6 large-4 js_login_trigger_region">
						<span class="invisible label inline text-neutral-1 text-uppercase">Book Now</span>
