...
<!-- Intro Section -->
<section class="intro-section fill-green-2 text-dark space-150-top-bottom" style="background-image: linear-gradient(-135deg, transparent 60%, var(--yellow) 100%), url('../../../media/characters/intro-section/char-<?php echo rand( 1, 5 ) ?>.png?v=20181126'), url('../../../media/characters/intro-section/intro-section-bg-px.png?v=20181126');">
	<div class="container">
		<div class="intro row space-50-bottom">
			<div class="columns small-10 small-offset-1">
				...
				<div class="h3 scroll-reveal">Say no to landlords, brokers and rent.</div>
	...
	<div class="container">
		<div class="row">
			<div class="checkin columns small-10 small-offset-1 space-100-top">
				...
				<div class="h4 text-neutral-3 scroll-reveal">Just carry <span class="strong text-green-2 sparkle title-3-left title-3-right scroll-reveal pop">any one</span> of these KYC documents for a quick check-in.</div>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="contact columns small-10 small-offset-1 large-8">
				...
				<a href="tel:+91-82877-70011" class="h3 strong inline scroll-reveal pop"><span class="sparkle or-light h5 strong text-green-2 text-uppercase">or</span> Call us on <span class="sparkle or-number-light text-green-2 no-wrap">+91-828-7770011</span></a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="trap row space-150-top-bottom">
			<div class="columns small-10 small-offset-1 xlarge-9 space-50-top-bottom">
				<div class="h3 strong"><span class="opacity-50 scroll-reveal">Peace of mind for you and </span><span class="sparkle title-2-left title-2-right scroll-reveal pop">your parents</span></div>
...
<section class="testimonial-section space-150-top-bottom">
	...
	<!-- Testimonials -->
	<div class="testimonials carousel block space-50-top-bottom js_carousel_container scroll-reveal">
		<div class="carousel-list js_carousel_content">
			<div class="carousel-list-item js_carousel_item">
		...
		<div class="row">
			<div class="columns small-10 small-offset-1">
				...
				<div class="space-100-top">
					<a href="tel:+91-82877-70011" class="h3 strong inline scroll-reveal pop"><span class="sparkle or-dark h5 strong text-yellow text-uppercase">or</span> Call us on <span class="sparkle or-number-dark text-yellow no-wrap">+91-828-7770011</span></a>
				</div>
			</div>
		</div>
	</div>
